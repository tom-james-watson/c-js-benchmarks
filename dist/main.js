...
/***/ "./src/benchmarks/fibonacci/fibonacci.js":
/*!***********************************************!*\
  !*** ./src/benchmarks/fibonacci/fibonacci.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction fib(n) {\n  let a = 1\n  let b = 1\n  let tmp = 0\n\n  while (n > 1) {\n    tmp = b\n    b += a\n    a = tmp\n    --n\n  }\n\n  return a\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (function(n, iterations) {\n  let result\n\n  for (let i = 0; i < iterations; i++) {\n    result = fib(n);\n  }\n\n  return result;\n});\n\n\n//# sourceURL=webpack:///./src/benchmarks/fibonacci/fibonacci.js?");

/***/ }),

/***/ "./src/benchmarks/fibonacci/index.js":
/*!*******************************************!*\
  !*** ./src/benchmarks/fibonacci/index.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Fibonacci; });\n/* harmony import */ var _fibonacci__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fibonacci */ \"./src/benchmarks/fibonacci/fibonacci.js\");\n\n\nclass Fibonacci {\n\n  static get args() {\n    return {\n      number: {\n        default: 40,\n        min: 1,\n        max: 46\n      },\n      iterations: {\n        default: 1000000,\n        min: 1,\n        max: 100000000\n      }\n    }\n  }\n\n  static get links() { return {\n    c: 'https://github.com/tom-james-watson/c-js-benchmarks/blob/master/src/benchmarks/fibonacci/fibonacci.c',\n    js: 'https://github.com/tom-james-watson/c-js-benchmarks/blob/master/src/benchmarks/fibonacci/fibonacci.js'\n  }}\n\n  constructor(args) {\n    this.iterations = args.iterations\n    this.number = args.number\n  }\n\n  c() {\n    return Module.ccall(\n      'fibonacci',\n      'number',\n      ['number', 'number'],\n      [this.number, this.iterations]\n    )\n  }\n\n  js() {\n    return Object(_fibonacci__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this.number, this.iterations)\n  }\n\n  compare(cResult, jsResult) {\n    console.log(cResult)\n    return cResult === jsResult\n  }\n\n}\n\n\n//# sourceURL=webpack:///./src/benchmarks/fibonacci/index.js?");
